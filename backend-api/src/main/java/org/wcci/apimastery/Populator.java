...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Song paranoid6 = new Song("Hand Of Doom", "Black Sabbath", album1, 7:08);
        ...
        Song shaggs2 = new Song("That Little Sports Car", "The Shaggs", album2, 2:06);
        ...
        Song shaggs5 = new Song("My Companion", "The Shaggs", album2, 2:04);
        ...
        Song shaggs12 = new Song("We Have A Savior", "The Shaggs", album2, 3:06);
        ...
        Song megadrive4 = new Song("Memory Dealer", "Mega Drive", album3, 5:02);
        ...
        Song megadrive12 = new Song("Slum Lord", "Mega Drive", album3, 5:00);
        ...
        Song neilyoung5 = new Song("Barstool Blues", "Neil Young", album4, 3:02);
